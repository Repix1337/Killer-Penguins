    ...
    const renderTowerContent = () => {
        const baseTowerData = {
            basic: {
                ...
                path1: "Path 1: Attack Speed - Multiple targets and faster firing with acceleration",
                path2: "Path 2: Heavy Damage - Increasing damage with enemy marking capabilities"
            },
            sniper: {
                name: "Sniper Tower",
                cost: 200,
            ...
            gasSpitter: {
                name: "Gas Spitter",
                cost: 300,
                description: "Poisons enemies with damage over time (20 damage + 25 poison/tick)",
            ...
            rapidShooter: {
                ...
                path1: "Path 1: Multi-shot - Multiple target attacks and low HP execution",
            ...
            mortar: {
                name: "Mortar Tower",
                cost: 1200,
                description: "Long-range explosive damage (450 damage, 8500ms interval)",
                path1: "Path 1: Heavy Artillery - Massive boss damage with long intervals",
            ...
            cannon: {
                name: "Cannon Tower",
                cost: 500,
                description: "Medium-range explosive damage (100 damage, 2750ms interval)",
                path1: "Path 1: Critical Strike - High damage with critical hit chance",
                path2: "Path 2: Area Control - Area damage and current health percentage damage",
            }
        };
                                                ...
                                                .map((upgrade, index) => (
                                                    <div key={index} className="upgrade-item">
                                                        <p className="text-red-300">
                                                            {`Path 1-${index + 1}: ${upgrade.name} (${upgrade.cost}$) - ${upgrade.description}`}
                                                        </p>
                                                    </div>
                                                ))}
                                        </div>
                                                ...
                                                .map((upgrade, index) => (
                                                    <div key={index} className="upgrade-item">
                                                        <p className="text-blue-300">
                                                            {`Path 2-${index + 1}: ${upgrade.name} (${upgrade.cost}$) - ${upgrade.description}`}
                                                        </p>
                                                    </div>
                                                ))}
                                        </div>
    ...
    const renderMechanicsContent = () => (
        <div className="space-y-6">
            ...
            <div className="bg-sky-800/80 p-4 rounded-lg border border-cyan-400/30">
                ...
                <p className="text-gray-300">• Yellow circle shows tower&apos;s range</p>
